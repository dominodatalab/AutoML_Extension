...
ARG EXTENSION_DOMINO_PROJECT_NAME=${EXTENSION_DOMINO_PROJECT_NAME:-AutoML_Extension}
...
ENV DATABASE_URL=sqlite:////mnt/data/$EXTENSION_DOMINO_PROJECT_NAME/automl.db
